...
import { Project } from "../../app/Projects/schema";

interface Props {
  type?: string;
  register: UseFormRegister<Project>;
  title: string;
  id: keyof Project; // تعديل النوع لـ keyof Project
  readOnly?: boolean;
  value?: string;
}
